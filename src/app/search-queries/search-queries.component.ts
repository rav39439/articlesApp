 ...
 let tagsinques = tagsTosearch.map(e => e.tag)
  ...
  if (typeof (totaldocs) != 'undefined' && totaldocs.length > 0) {
      totaldocs.forEach((e) => {
          let doc = e
          if (doc != null) {
              let value = this.getExactAnsFromtext(doc, tagsTosearch, html1)[0]
...
getExactAnsFromtext(doc, tagsTosearch, html1) {
  let docs:any = []
  let newtags:any = []
  ...
  if (tagsTosearch.length > 0) {
     ...
     let wordstosearch = tagsTosearch.map(e => e.tag)
      ...
      let value2 =this. ArrwithAllwordsAlt(arrayofTexts, wordstosearch, doc.Text, docs, doc)
      if (typeof (value2) != 'undefined' && value1 !== null && value2 !== null &&
          ...
          if (value1 != value2) {
              ...
              html1.push(this.ArrwithAllwords(arrayofTexts, wordstosearch, doc.Text, docs, doc))
          }
      }
...
ArrwithAllwordsAlt(arrayofTexts, wordsToSearch, htmlText, docs, doc) {
  let counts:any=[]
